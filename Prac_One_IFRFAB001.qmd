...
# Practical One {.unnumbered style="text-align: center"}

## Task 1: Missing Values {.unnumbered}
...
## Task 2: Statistical Analysis of Ozone and Temperature {.unnumbered}
...
## Task 3: Linear Modelling Without Using lm() {.unnumbered}
...
## Task 4: Comparison With lm() {.unnumbered}
